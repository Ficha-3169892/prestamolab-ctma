...
HISTORIAS = [
    ...
    },
    {
        ...
        "criterios": [
            ...
            ("inicié sesión como INSTRUCTOR", "abro el detalle de un equipo",
             ...
             "UI", "Sesión falsa con rol INSTRUCTOR.", ""),
        ],
    },
    {
    ...
    {
        "id": "HU05", "titulo": "Registrar devolución", "prioridad": "Alta", "sprint": 7,
        "rol": "estudiante", "quiero": "registrar la devolución de un equipo prestado",
        "para": "cerrar mi préstamo y liberar el equipo",
        "criterios": [
            ("tengo un préstamo en estado PRESTADO", "abro su detalle",
             "veo la opción \"Registrar devolución\"; en otros estados no aparece",
             "UI", "Préstamos en SOLICITADA, PRESTADO y DEVUELTO.", ""),
            ("tengo un préstamo PRESTADO", "registro la devolución",
             "el préstamo pasa a DEVUELTO y el equipo a DISPONIBLE",
             "Unitaria (TDD)", "Transición PRESTADO → DEVUELTO.", ""),
            ("estoy registrando la devolución", "elijo el estado del equipo (Bueno, Con novedad, Dañado) y escribo una observación",
             "se guarda un registro en `returns` con esos datos y la fecha/hora",
             "Integración", "Room en memoria; verificar ReturnEntity.", ""),
            ("marco el equipo como Dañado", "guardo la devolución",
             "la observación es obligatoria (mínimo 10 caracteres)",
             "Unitaria", "Estado Dañado con observación vacía.", ""),
    ...
    {
        "id": "HU13", "titulo": "Registrar geolocalización de las operaciones", "prioridad": "Media", "sprint": 7,
        ...
        "criterios": [
            ("no he concedido permisos de ubicación", "solicito un préstamo",
             "la app pide primero ubicación aproximada (COARSE) y solo pide la precisa (FINE) en esa acción",
             "Instrumentada", "Permisos revocados; verificar el diálogo del sistema.", ""),
            ...
            ("concedí el permiso de ubicación", "registro una devolución o adjunto una evidencia",
             "el registro guarda latitud y longitud de ese momento",
             "Unitaria", "LocationProvider falso.", ""),
            ("negué el permiso o el GPS está desactivado", "solicito o devuelvo",
             "la operación se completa sin coordenadas, marcada \"sin ubicación\", y se muestra un aviso",
             "Unitaria", "LocationProvider que devuelve error o null.", ""),
            ("hay registros con coordenadas", "se sincroniza",
             "latitud y longitud llegan a Supabase en el registro correspondiente",
