...
HISTORIAS = [
    {
        ...
        "criterios": [
            ...
            ("un equipo no está DISPONIBLE", "veo el catálogo",
             ...
             "UI", "Semilla: Osciloscopio en RESERVADO. Verificar estilo del estado.", "ColorEstadoTest.TC_HU01_02_LosNoDisponiblesTienenUnColorDistintoAlDeLosDisponibles"),
            ("hay equipos de varias categorías", "activo el filtro \"Solo disponibles\" o elijo una categoría",
             ...
             "Unitaria", "ViewModel con repositorio falso; aplicar filtro categoría = Herramienta.", "FiltroCatalogoTest.TC_HU01_03_SoloDisponibles; FiltroCatalogoTest.TC_HU01_03_PorCategoria; PrestamoViewModelTest.TC-HU01-03; CatalogoFiltrosUiTest.TC_HU01_03_SoloDisponiblesYCategoria_FiltranLaLista"),
            ("apliqué un filtro", "cierro y vuelvo a abrir la app",
             "el filtro se conserva (DataStore)",
             "Instrumentada", "Aplicar filtro, recrear la actividad, verificar filtro activo.", "CatalogoFiltrosUiTest.TC_HU01_04_ElFiltroSeConservaAlCerrarYVolverAAbrirLaApp; PrestamoViewModelTest.TC-HU01-04"),
            ("no hay equipos que cumplan el filtro", "veo el catálogo",
             ...
             "UI", "Filtro por categoría inexistente.", "CatalogoFiltrosUiTest.TC_HU01_05_SinResultados_MuestraElMensajeYSePuedenQuitarLosFiltros; PrestamoViewModelTest.TC-HU01-05"),
        ],
    },
    {
    ...
    },
    {
        ...
        "criterios": [
            ...
            ("el equipo está RESERVADO o PRESTADO", "intento solicitarlo",
             ...
             "PrestamoViewModelTest.TC-12; RoomPrestamoRepositoryTest.CrearSolicitudSobreEquipoReservado_FallaSinCrearRegistros"),
    ...
    },
    {
        ...
        "criterios": [
            ("hay solicitudes de varios usuarios", "abro \"Mis Solicitudes\"",
             ...
             "Unitaria", "Repositorio con solicitudes de 2 usuarios; sesión del usuario A.", "PrestamoViewModelTest.Mis Solicitudes del estudiante solo muestra las suyas y el instructor ve todas"),
            ("tengo solicitudes", "abro \"Mis Solicitudes\"",
             "cada una muestra equipo, fechas, ambiente y estado",
             "UI", "Solicitud semilla #1.", "CatalogoFiltrosUiTest.TC_HU04_02_CadaSolicitudMuestraEquipoFechasAmbienteYEstado"),
            ...
            ("no tengo solicitudes activas", "abro \"Mis Solicitudes\"",
             ...
             "UI", "Usuario sin solicitudes.", "CatalogoFiltrosUiTest.TC_HU04_04_SinSolicitudesActivas_MuestraElMensaje"),
            ...
            ("una solicitud ya está CANCELADA", "intento cancelarla otra vez",
             ...
             "PrestamoViewModelTest.TC-16; RoomPrestamoRepositoryTest.Cancelar_EsIdempotenteYLiberaElEquipo"),
        ],
    },
    {
        ...
        "criterios": [
            ...
            ("estoy registrando la devolución", "elijo el estado del equipo (Bueno, Con novedad, Dañado) y escribo una observación",
             ...
             "Unitaria + Integración", "ViewModel con repositorio en memoria; Room en memoria verifica ReturnEntity.",
             "DevolucionViewModelTest.TC-HU05-03; RoomPrestamoRepositoryTest.TC_HU05_03_Devolucion_GuardaReturnEntityConCondicionFechaYUbicacion"),
            ...
            ("el préstamo ya está DEVUELTO", "intento devolverlo otra vez",
             ...
             "RoomPrestamoRepositoryTest.TC_HU05_05_DevolverUnPrestamoYaDevuelto_SeRechazaSinCambios"),
        ],
    },
    {
        ...
        "criterios": [
            ("hay datos guardados", "reinicio la app en modo avión",
             ...
             "Instrumentada", "Cargar datos, activar modo avión, recrear el proceso.", "PersistenciaSinConexionTest.TC_HU06_01_TrasReiniciarSinRedElCatalogoYMisPrestamosSiguenVisibles"),
            ("no hay conexión", "creo una solicitud",
             "se guarda localmente con estado de sincronización PENDIENTE",
             "Integración", "Room en memoria; remoto simulado sin red.", "RoomPrestamoRepositoryTest.TC_HU06_02_SolicitudNueva_QuedaPendienteConUuidYPideSincronizar"),
            ("la app está en uso", "cambian los datos en Room",
             ...
             "RoomPrestamoRepositoryTest.TC_HU06_03_ElFlujoDeEquiposEmiteLosCambiosDeRoom"),
            ("existe una versión anterior de la base de datos", "actualizo la app",
             "la migración conserva los datos existentes",
             "Instrumentada", "MigrationTestHelper de v1 a v2.", "MigracionTest.TC_HU06_04_MigracionDeV1AV2ConservaLosDatos"),
            ("existen entidades relacionadas", "consulto un préstamo",
             ...
             "Integración", "DAO: LoanWithEquipment / LoanWithEvidences.", "RoomPrestamoRepositoryTest.TC_HU06_05_ElPrestamoLlegaConSuEquipoYSusEvidenciasEnUnaSolaConsulta"),
        ],
    },
    {
        ...
        "criterios": [
            ("hay registros PENDIENTES", "se recupera la conexión",
             ...
             "Integración", "MockWebServer responde 201; WorkManager de prueba.", "SincronizadorPrestamosTest.TC_HU07_01_PendientesSeEnvianYQuedanSincronizados; SupabasePrestamosDataSourceTest.TC-HU07-01"),
            ("el servidor responde 200 con datos nuevos", "se sincroniza",
             "Room se actualiza y la UI muestra los datos remotos",
             "Integración", "MockWebServer 200 con JSON de equipos.", "SincronizadorPrestamosTest.TC_HU07_02_DatosRemotosNuevosActualizanRoom; SupabasePrestamosDataSourceTest.TC-HU07-02"),
            ("el servidor responde 401", "se sincroniza",
             "se cierra la sesión y se lleva al usuario al login",
             "Integración", "MockWebServer 401.", "CoordinadorSincronizacionTest.TC-HU07-03; SincronizacionWorkerTest.TC_HU07_03_Respuesta401_CierraLaSesionYFalla; SupabasePrestamosDataSourceTest.TC-HU07-03"),
            ("el servidor responde 404", "se sincroniza un recurso",
             "se muestra un mensaje y los datos locales se conservan",
             "Integración", "MockWebServer 404.", "CoordinadorSincronizacionTest.TC-HU07-04; SincronizadorPrestamosTest.TC_HU07_04_Respuesta404ConservaLosDatosLocales; PrestamoViewModelTest.TC-HU07-04"),
            ("el servidor responde 5xx o se agota el tiempo de espera", "se sincroniza",
             ...
             "Integración", "MockWebServer 500/503 y respuesta con retraso mayor al timeout.", "SincronizacionWorkerTest.TC_HU07_05_Error5xx_PideReintentarConEsperaExponencial; SincronizadorPrestamosTest.TC_HU07_05_Error5xxOTiempoAgotadoDejaLosRegistrosPendientes; SupabasePrestamosDataSourceTest.TC-HU07-05"),
        ],
    },
    {
        ...
        "criterios": [
            ("no he concedido el permiso de cámara", "toco \"Adjuntar evidencia\"",
             ...
             "Instrumentada", "Permiso revocado con `adb shell pm revoke`.", "EvidenciasUiTest.TC_HU08_01_Y_03_ElPermisoSePideAlAdjuntar_YNegarloMuestraUnMensaje"),
            ("tomo una foto", "confirmo la captura",
             "la imagen se guarda mediante FileProvider y su URI queda asociada al préstamo en Room",
             "Integración", "TakePicture simulado; verificar EvidenceEntity.", "EvidenciasDatosTest.TC_HU08_02_LaUriQuedaAsociadaAlPrestamoEnRoom; EvidenciasViewModelTest.TC_HU08_02_AlConfirmarLaFoto_SuUriQuedaAsociadaAlPrestamo"),
            ("niego el permiso de cámara", "intento adjuntar",
             "veo un mensaje explicativo y la app sigue funcionando",
             "Instrumentada", "Negar el permiso.", "EvidenciasUiTest.TC_HU08_01_Y_03_ElPermisoSePideAlAdjuntar_YNegarloMuestraUnMensaje; EvidenciasViewModelTest.TC_HU08_03_PermisoNegado_MuestraUnMensajeExplicativo"),
            ("abro la cámara", "cancelo sin tomar foto",
             "no se crea ninguna evidencia",
             "Unitaria", "Resultado de TakePicture = false.", "EvidenciasViewModelTest.TC_HU08_04_CancelarLaCamara_NoCreaEvidenciaYBorraElArchivo"),
            ("hay evidencias sin subir", "se sincroniza",
             "las fotos se suben a Supabase Storage y se guarda su URL remota",
             "Integración", "MockWebServer para Storage.", "SincronizadorPrestamosTest.TC_HU08_05_LaFotoSeSubeAStorageYSeGuardaSuUrlRemota; SupabasePrestamosDataSourceTest.TC-HU08-05"),
        ],
    },
    {
        ...
        "criterios": [
            ("un préstamo pasa a PRESTADO", "se registra el cambio",
             ...
             "Integración", "WorkManagerTestInitHelper; verificar el trabajo programado.", "WorkManagerRecordatoriosTest.TC_HU09_01_SeProgramaUnTrabajoParaLaHoraDelAviso; PlanRecordatoriosTest.TC_HU09_01_PrestamoPrestado_SeProgramaTreintaMinutosAntesDelFin; CoordinadorRecordatoriosTest.TC_HU09_01_AlAprobarseUnaSolicitudSeProgramaSuRecordatorio"),
            ("llega la hora del recordatorio", "se muestra la notificación",
             "indica el equipo y la hora límite, y al tocarla abre el préstamo",
             "Instrumentada", "Adelantar el reloj de prueba de WorkManager.", "RecordatorioWorkerTest.TC_HU09_02_AlLlegarLaHora_MuestraElEquipoYLaHoraLimite; AndroidNotificadorTest.TC_HU09_02_PublicaElAvisoConEquipoHoraYAccionDeApertura; RecordatorioUiTest.TC_HU09_02_TocarElRecordatorio_AbreElPrestamo"),
    ...
    },
    {
        ...
        "criterios": [
            ("tengo una cuenta válida", "ingreso mi correo o documento y mi contraseña correctos",
             "se inicia la sesión, se carga mi rol y veo la pantalla de inicio de ese rol",
             "Unitaria", "Tabla users simulada con password_hash = SHA-256('123456'); correo o documento.",
            ...
            ("estoy en el login", "ingreso credenciales incorrectas",
             "veo \"Usuario o contraseña incorrectos\" y no avanzo",
             "Unitaria", "Tabla users simulada sin coincidencia para correo + contraseña.",
             "LoginViewModelTest.TC-HU10-02; LoginUiTest.TC_HU10_02_LoginInvalido_MuestraErrorYSigueEnLogin"),
            ("estoy en el login", "dejo vacío el correo/documento o la contraseña, o el formato no es válido",
             "veo el error del campo sin llamar al servidor",
             "Unitaria", "\"\", \"correo@sin-dominio\", documento \"12-3\", contraseña vacía.",
            ...
            ("inicié sesión", "cierro y vuelvo a abrir la app",
             "la sesión se mantiene (user_id, email, role y full_name guardados en DataStore)",
            ...
            ("inicié sesión", "cierro sesión",
             "se borran el usuario y el rol, y vuelvo al login",
            ...
            ("inicié sesión como INSTRUCTOR", "entro a la app",
             "inicio en Gestión y veo las pantallas de inventario, actividades y revisión de solicitudes",
             "UI", "Sesión INSTRUCTOR.",
             "ControlAccesoTest.TC-HU10-07; LoginUiTest.TC_HU10_07_Instructor_IniciaEnGestion"),
        ],
    },
    {
        ...
        "criterios": [
            ("soy INSTRUCTOR", "creo una actividad con título, descripción, ambiente y fecha",
             ...
             "Integración", "DAO de actividades en memoria.", "RoomActividadRepositoryTest.TC_HU11_01_CrearActividad_QuedaGuardadaYApareceEnLaLista; ActividadesViewModelTest.TC-HU11-01; ActividadesUiTest.TC_HU11_01_CrearActividad_ApareceEnLaLista"),
            ("estoy creando una actividad", "dejo el título vacío o elijo una fecha pasada",
             "veo el error del campo y no se guarda",
             "Unitaria", "Título \"\"; fecha de ayer.", "ReglasActividadTest.TC_HU11_02_TituloVacio_MuestraErrorDelCampo; ReglasActividadTest.TC_HU11_02_FechaPasada_MuestraErrorDelCampo; ActividadesUiTest.TC_HU11_02_TituloVacioYFechaPasada_MuestranErroresYNoSeGuarda"),
            ("existe una actividad", "la edito y guardo",
             "los cambios se reflejan en la lista",
             "Integración", "Actualizar el título.", "RoomActividadRepositoryTest.TC_HU11_03_EditarActividad_ReflejaLosCambios; ActividadesUiTest.TC_HU11_03_EditarActividad_SeReflejaEnLaLista"),
            ("existe una actividad", "la elimino y confirmo",
             "desaparece de la lista; si cancelo la confirmación, se conserva",
             "UI", "Diálogo de confirmación.", "ActividadesUiTest.TC_HU11_04_EliminarConConfirmacion_YCancelarLaConserva; RoomActividadRepositoryTest.TC_HU11_04_EliminarActividad_DesapareceYQuedaPendienteDeEnviar"),
            ("soy ESTUDIANTE", "abro Actividades",
             "las veo en modo solo lectura, sin opciones de crear, editar ni eliminar",
             "UI", "Sesión ESTUDIANTE.", "ActividadesUiTest.TC_HU11_05_ElEstudianteVeLasActividadesEnSoloLectura; ControlAccesoTest.TC-HU11-05; ActividadesViewModelTest.TC-HU11-05"),
        ],
    },
    {
        ...
        "criterios": [
            ("soy INSTRUCTOR", "registro un equipo con nombre y categoría",
             ...
             "Integración", "DAO de equipos en memoria.", "RoomPrestamoRepositoryTest.TC_HU12_01_RegistrarEquipo_QuedaDisponibleEnElCatalogoYPendienteDeEnviar; InventarioViewModelTest.TC-HU12-01; InventarioUiTest.TC_HU12_01_RegistrarEquipo_ApareceDisponibleEnElCatalogo"),
            ("estoy registrando un equipo", "dejo vacío el nombre o la categoría",
             "veo el error del campo y no se guarda",
             "Unitaria", "Nombre \"\".", "ReglasInventarioTest.TC_HU12_02_NombreVacio_MuestraErrorDelCampo; InventarioViewModelTest.TC-HU12-02; InventarioUiTest.TC_HU12_02_CamposVacios_MuestranErroresYNoSeGuarda"),
            ("existe un equipo", "edito sus datos",
             "los cambios se ven en el catálogo y en el detalle",
             "Integración", "Actualizar la categoría.", "RoomPrestamoRepositoryTest.TC_HU12_03_EditarEquipo_CambiaCatalogoYDetalle; InventarioUiTest.TC_HU12_03_EditarEquipo_SeVeEnElCatalogoYEnElDetalle"),
            ("el equipo tiene un préstamo activo (SOLICITADA o PRESTADO)", "intento eliminarlo",
             ...
             "Unitaria", "Equipo 2 con la solicitud #1.", "ReglasInventarioTest.TC_HU12_04_ConPrestamoActivo_LaEliminacionSeRechaza; RoomPrestamoRepositoryTest.TC_HU12_04_EliminarEquipoConPrestamoActivo_SeRechaza; InventarioUiTest.TC_HU12_04_EliminarEquipoConPrestamoActivo_MuestraElMotivo"),
            ("soy ESTUDIANTE", "abro el catálogo",
             "no veo opciones para crear, editar ni eliminar equipos",
             "UI", "Sesión ESTUDIANTE.", "InventarioUiTest.TC_HU12_05_ElEstudianteNoVeOpcionesDeInventario; ControlAccesoTest.TC-HU12-05"),
        ],
    },
    {
        ...
        "criterios": [
            ("no he concedido el permiso de ubicación", "toco \"Capturar ubicación actual\" al registrar una devolución",
             ...
             "Instrumentada", "Permisos revocados con `adb shell pm revoke`; el diálogo del sistema se detecta con UiAutomation y se rechaza con Atrás.", "PermisoUbicacionUiTest.TC_HU13_01_ElPermisoSePideAlCapturarLaUbicacion_YNegarloNoBloqueaLaDevolucion (se ejecuta aparte, tras revocar la ubicación)"),
            ...
            ("concedí el permiso de ubicación", "solicito un préstamo",
             ...
             "Unitaria", "LocationProvider falso con (6.2518, -75.5636).", "PrestamoViewModelTest.TC-HU13-03; RoomPrestamoRepositoryTest.TC_HU13_03_LaSolicitudGuardaLatitudLongitudYPrecision"),
            ...
            ("hay registros con coordenadas", "se sincroniza",
             ...
             "Integración", "MockWebServer: verificar el cuerpo JSON enviado.", "SincronizadorPrestamosTest.TC_HU13_06_LasCoordenadasDePrestamosYDevolucionesLleganASupabase; SupabasePrestamosDataSourceTest.TC-HU13-06"),
        ],
    },
    {
        ...
        "criterios": [
            ("hay solicitudes SOLICITADAS", "abro \"Revisar solicitudes\"",
             ...
             "UI", "Sesión INSTRUCTOR con la solicitud #1.", "RevisarSolicitudesUiTest.TC_HU14_01_ListaMuestraEstudianteEquipoAmbientePropositoYDuracion; ControlAccesoTest.TC-HU14-01"),
            ("reviso una solicitud SOLICITADA", "la apruebo",
             "pasa a PRESTADO y el equipo queda PRESTADO",
             "Unitaria (TDD)", "Transición SOLICITADA → PRESTADO.", "RevisionSolicitudTest.TC_HU14_02_AprobarSolicitada_PasaAPrestadoYEntregaElEquipo; RoomPrestamoRepositoryTest.TC_HU14_02_AprobarSolicitud_EntregaElEquipoYQuedaPendienteDeEnviar; RevisarSolicitudesUiTest.TC_HU14_02_AprobarQuitaLaSolicitudYElEquipoQuedaPrestado"),
            ("reviso una solicitud SOLICITADA", "la rechazo indicando el motivo",
             ...
             "Unitaria (TDD)", "Transición SOLICITADA → RECHAZADA.", "RevisionSolicitudTest.TC_HU14_03_RechazarSolicitada_GuardaElMotivoYLiberaElEquipo; RoomPrestamoRepositoryTest.TC_HU14_03_RechazarSolicitud_GuardaElMotivoYLiberaElEquipo; RevisarSolicitudesUiTest.TC_HU14_03_RechazarExigeMotivoYLiberaElEquipo"),
            ("la solicitud ya fue CANCELADA o RECHAZADA", "intento aprobarla",
             "la operación se rechaza sin cambios",
             "Unitaria (TDD)", "Transición inválida.", "RevisionSolicitudTest.TC_HU14_04_AprobarCanceladaORechazada_SeRechazaSinCambios; RoomPrestamoRepositoryTest.TC_HU14_04_AprobarUnaSolicitudCancelada_SeRechazaSinCambios"),
        ],
    },
]
