...
| [HU-13](HU13.md) | Registrar geolocalización de las operaciones | Media | 5 | 6 | 6 |
| [HU-01](HU01.md) | Consultar equipos disponibles | Alta | 6 | 5 | 5 |
| [HU-02](HU02.md) | Consultar detalle de un equipo | Alta | 6 | 4 | 4 |
| [HU-06](HU06.md) | Conservar datos localmente sin conexión | Alta | 6 | 5 | 5 |
...
| [HU-04](HU04.md) | Consultar mis préstamos activos | Alta | 7 | 6 | 6 |
...
**Total:** 74 criterios, 74 casos de prueba, 74 ya automatizados.
...
| HU01 | CA-HU01-02 | TC-HU01-02 | UI | `ColorEstadoTest.TC_HU01_02_LosNoDisponiblesTienenUnColorDistintoAlDeLosDisponibles` |
| HU01 | CA-HU01-03 | TC-HU01-03 | Unitaria | `FiltroCatalogoTest.TC_HU01_03_SoloDisponibles; FiltroCatalogoTest.TC_HU01_03_PorCategoria; PrestamoViewModelTest.TC-HU01-03; CatalogoFiltrosUiTest.TC_HU01_03_SoloDisponiblesYCategoria_FiltranLaLista` |
| HU01 | CA-HU01-04 | TC-HU01-04 | Instrumentada | `CatalogoFiltrosUiTest.TC_HU01_04_ElFiltroSeConservaAlCerrarYVolverAAbrirLaApp; PrestamoViewModelTest.TC-HU01-04` |
| HU01 | CA-HU01-05 | TC-HU01-05 | UI | `CatalogoFiltrosUiTest.TC_HU01_05_SinResultados_MuestraElMensajeYSePuedenQuitarLosFiltros; PrestamoViewModelTest.TC-HU01-05` |
...
| HU04 | CA-HU04-01 | TC-HU04-01 | Unitaria | `PrestamoViewModelTest.Mis Solicitudes del estudiante solo muestra las suyas y el instructor ve todas` |
| HU04 | CA-HU04-02 | TC-HU04-02 | UI | `CatalogoFiltrosUiTest.TC_HU04_02_CadaSolicitudMuestraEquipoFechasAmbienteYEstado` |
| HU04 | CA-HU04-03 | TC-HU04-03 | UI | `PrestamoUiTest.TC15_CancelarSolicitud_ActualizaLista` |
| HU04 | CA-HU04-04 | TC-HU04-04 | UI | `CatalogoFiltrosUiTest.TC_HU04_04_SinSolicitudesActivas_MuestraElMensaje` |
...
| HU06 | CA-HU06-01 | TC-HU06-01 | Instrumentada | `PersistenciaSinConexionTest.TC_HU06_01_TrasReiniciarSinRedElCatalogoYMisPrestamosSiguenVisibles` |
...
| HU06 | CA-HU06-05 | TC-HU06-05 | Integración | `RoomPrestamoRepositoryTest.TC_HU06_05_ElPrestamoLlegaConSuEquipoYSusEvidenciasEnUnaSolaConsulta` |
...
| HU13 | CA-HU13-01 | TC-HU13-01 | Instrumentada | `PermisoUbicacionUiTest.TC_HU13_01_ElPermisoSePideAlCapturarLaUbicacion_YNegarloNoBloqueaLaDevolucion (se ejecuta aparte, tras revocar la ubicación)` |
...
| HU13 | CA-HU13-03 | TC-HU13-03 | Unitaria | `PrestamoViewModelTest.TC-HU13-03; RoomPrestamoRepositoryTest.TC_HU13_03_LaSolicitudGuardaLatitudLongitudYPrecision` |
...
| HU13 | CA-HU13-06 | TC-HU13-06 | Integración | `SincronizadorPrestamosTest.TC_HU13_06_LasCoordenadasDePrestamosYDevolucionesLleganASupabase; SupabasePrestamosDataSourceTest.TC-HU13-06` |
